 ...
 * @author a.yusupova
 */
public class Task55 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTitledPanel1.setTitleColor(new java.awt.Color(255, 51, 51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task55.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
